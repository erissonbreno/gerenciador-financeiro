...
interface AccountFormModalFormProps {
  account: AccountWithDerived | null
  patients: Patient[]
  onSave: (data: AccountFormData) => void
  onClose: () => void
...
function AccountFormModalForm({ account, patients, onSave, onClose }: AccountFormModalFormProps) {
  const [form, setForm] = useState<AccountFormData>(() =>
    account ? { ...emptyForm, ...account } : emptyForm,
  )
